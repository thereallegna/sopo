...
export const convertStockMutationFromForm = (
    item: TransactionItem
): StockMutatedFromFormBody => ({
    // document_number: item.item_code,
    // d_no: item.item_code,
    item_code: item.item_code,
    item_name: item.item_name,
    batch: item.batch,
...
export const convertStockMutationToForm = (
    item: MasterItemFormBody
): StockMutatedToFormBody => ({
    // document_number: item.item_code || "",
    // d_no: item.item_code || "",
    item_code: item.item_code || "",
    item_name: item.item_name,
