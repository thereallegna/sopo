      ...
      >
        <div className="flex items-center p-1">
          ...
          <div className="flex flex-col text-base font-semibold ml-[10px]">
            <span>{isLoading ? 'loading...' : data?.usercode || 'Guest'}</span>
            <span className="text-[10px] font-normal">Administrator</span>
          </div>
        </div>
        <hr className="border-neutral-200 mt-2 -mx-2" />
        <div className="flex items-center mt-0 -mb-2 p-1">
          <div className="flex items-center justify-center">
            <IconComponent icon={IconSettings2} size="medium" color="dark" />
          </div>
          <div className="flex items-center justify-center">
            <Button
        ...
        <div className="flex items-center mt-0 -mb-2 p-1">
          <div className="flex items-center justify-center">
            <IconComponent icon={IconLogout} size="medium" color="dark" />
          </div>
          <div className="flex items-center justify-center">
            <Button
              className="text-[10px] font-normal"
