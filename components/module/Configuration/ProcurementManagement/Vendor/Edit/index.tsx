...
const EditVendor = () => {
  ...
  return (
    <Drawer onClose={handleCloseDrawerEdit} open={isOpenEdit}>
      <DrawerContent>
        <DrawerHeader onClick={handleCloseDrawerEdit} drawerTitle="Edit Vendor">
          <DrawerEndHeader>
            <Button
              ...
              <CardContent className="flex-wrap flex flex-row gap-6">
                <div className="flex flex-col gap-[14px] flex-1">
                  <InputField
                    ...
                    message={
                      errors.vendor_code
                        ? { text: errors.vendor_code.message!, type: 'danger' }
                        : undefined
                    }
                    label="Vendor Code"
                  ...
                  <InputField
                    ...
                    message={
                      errors.vendor_name
                        ? { text: errors.vendor_name.message!, type: 'danger' }
                        : undefined
                    }
                    label="Vendor Name"
                  ...
                  <Combobox
                    ...
                    message={
                      errors.vendor_category
                        ? {
                            text: errors.vendor_category.message!,
                            type: 'danger',
                          }
                        : undefined
                    }
                    value={{
                      ...
                      value: watch('vendor_category_code'),
                    }}
                    onChange={(val) => {
                      setValue('vendor_category', val.label, {
                        shouldDirty: true,
                      });
                      setValue('vendor_category_code', val.value, {
                        shouldDirty: true,
                      });
                      setError('vendor_category', { type: 'disabled' });
                    }}
                  />
                  <InputField
                    {...register('address')}
                ...
                <div className="flex flex-col gap-[14px] flex-1 h-full justify-between">
                  ...
                  <InputField
                    ...
                    message={
                      errors.website
                        ? { text: errors.website.message!, type: 'danger' }
                        : undefined
                    }
                    label="Website"
                    placeholder="Website"
                  ...
                  <InputField
                    ...
                    message={
                      errors.head_office
                        ? { text: errors.head_office.message!, type: 'danger' }
                        : undefined
                    }
                    label="Head Office"
