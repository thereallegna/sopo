...
const CreateWarehouse = () => {
  ...
  return (
    <Drawer onClose={handleCloseDrawer} open={isOpen}>
      <DrawerContent>
        <DrawerHeader onClick={handleCloseDrawer} drawerTitle="Add Warehouse">
          <DrawerEndHeader>
            <Button
                  ...
                  <InputField
                    ...
                    message={
                      errors.warehouse_code
                        ? {
                            text: errors.warehouse_code.message!,
                            type: 'danger',
                          }
                        : undefined
                    }
                ...
                <div className="flex flex-col gap-[14px] flex-1 h-full justify-between">
                  <Combobox
                    ...
                    onChange={(val) => {
                      ...
                      setError('city_name', { type: 'disabled' });
                    }}
                  />
                  <InputField
                  ...
                  <InputField
                    ...
                    message={
                      errors.contact_person
                        ? {
                            text: errors.contact_person.message!,
                            type: 'danger',
                          }
                        : undefined
                    }
